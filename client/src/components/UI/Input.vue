...
const baseInputClasses = 'block px-4 py-2.5 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 border rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed'
